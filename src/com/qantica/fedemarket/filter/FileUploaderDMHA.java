...
public class FileUploaderDMHA implements Filter {

	private final static Logger logger = Logger.getLogger(FileUploaderDMHA.class.getName());
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
            ...
            if(isMultipart) {
                    ...
                    System.out.println(servletFileUpload+" - "+multipartRequest+" - "+request+" - "+filterChain);
